...
class Wallet
{
	...
	*/
	...
	public Wallet(String user)throws IOException
	{
	...
	public Wallet(String user,double balance)throws IOException
	{
		System.out.println("__>"+user);
		this.user=user;
		this.date=date.now();
	...
	public void loadWallets()throws IOException
	{
		...
		if(file.exists())
		{
			...
			writeToWalletFile("Wallet.txt","User:0.00:last updated");
	}
	...
	public void addNewUserToWallet()throws IOException
	{
		...
		{
			writeToWalletFile("Wallet.txt",this.user+":"+this.balance+":"+"Last Updated on "+date+" at "+time);
		}
	}
	public void changeBalance()throws IOException
	{
		int i=0;
		PrintWriter write=new PrintWriter("Wallet.txt");
		if(walletList.get(0).contains(this.user))
		{
	...
	public static void main(String[] args)throws IOException {
		Wallet wal=new Wallet(args[0],2.00);
		wal.addNewUserToWallet();
		wal.changeBalance();
		System.out.println(wal.getBalance());

	}
	public void walletDialog(Label curency,Label oldBal1)throws IOException
	{
